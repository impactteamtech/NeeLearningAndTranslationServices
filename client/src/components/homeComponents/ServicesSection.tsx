      ...
      >
        ...
        >
          ...
          <Link
            ...
            className="group inline-flex items-center gap-[14px] bg-gradient-to-br from-[#080c18] via-[#0d1f7a] to-[#00209F] text-white rounded-full font-sans text-[13px] font-bold tracking-[0.12em] uppercase no-underline whitespace-nowrap relative overflow-hidden shadow-[0_4px_20px_rgba(0,32,159,0.40),0_1px_6px_rgba(8,12,24,0.30)] transition-[transform,box-shadow] duration-300 hover:-translate-y-[3px] hover:shadow-[0_12px_40px_rgba(0,32,159,0.55),0_4px_12px_rgba(8,12,24,0.35)] active:-translate-y-[1px]"
            style={{ padding: "16px 28px 16px 36px" }}
          >
            <span className="relative z-10">View All Services</span>
            <span className="relative z-10 w-[34px] h-[34px] rounded-full bg-white/[0.18] flex items-center justify-center flex-shrink-0 transition-[background,transform] duration-[250ms] group-hover:bg-white/[0.28] group-hover:translate-x-[3px]">
              <IoIosArrowRoundForward
                aria-hidden="true"
